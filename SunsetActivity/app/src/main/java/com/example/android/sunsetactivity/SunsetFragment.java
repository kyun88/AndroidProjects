package com.example.android.sunsetactivity;
...
public class SunsetFragment extends Fragment {
    ...
    private void startAnimation() {
        ...
        sunsetSkyAnimator.setEvaluator(new android.animation.ArgbEvaluator());
        ...
        nightSkyAnimator.setEvaluator(new android.animation.ArgbEvaluator());
